...
public class SequentialGuidGenerator(IOptions<SequentialGuidGeneratorOptions> options) : IGuidGenerator
{
	public SequentialGuidGeneratorOptions Options = options.Value;
